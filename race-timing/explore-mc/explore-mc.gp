...
set output 'explore-mc-'.platform.'.png'
...
plot 'explore-mc-acc-'.platform.'.dat' matrix using (1+$1):(1+$2):3 with image

## Assertion count Matrix
set cbrange[0:1000]
set cbtics 0,200,1000 font ',13'
plot 'explore-mc-pos-'.platform.'.dat' matrix using (1+$1):(1+$2):3 with image
